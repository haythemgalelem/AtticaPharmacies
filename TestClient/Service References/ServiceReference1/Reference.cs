...
namespace TestClient.ServiceReference1 {
    ...
    public partial class PharmacyOnDuty : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private double AddressLongituteField;
        ...
        public double AddressLongitute {
            get {
                return this.AddressLongituteField;
            }
            set {
                if ((this.AddressLongituteField.Equals(value) != true)) {
                    this.AddressLongituteField = value;
                    this.RaisePropertyChanged("AddressLongitute");
                }
            }
        }
        ...
        public double AddressLatitude {
            ...
            set {
                if ((this.AddressLatitudeField.Equals(value) != true)) {
                    this.AddressLatitudeField = value;
                    this.RaisePropertyChanged("AddressLatitude");
                }
            }
        }
